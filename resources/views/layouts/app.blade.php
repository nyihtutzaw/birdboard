            ...
            <div class="container mx-auto px-6 md:px-0">
                <div class="flex items-center justify-center">
                    ...
                    <div class="flex-1 text-right">
                        @guest
                            <a class="no-underline hover:underline text-white-300 text-sm p-3" href="{{ route('login') }}">{{ __('Login') }}</a>
                            @if (Route::has('register'))
                                <a class="no-underline hover:underline text-white-300 text-sm p-3" href="{{ route('register') }}">{{ __('Register') }}</a>
                            @endif
                        @else
                            <span class="text-white-300 text-sm pr-4">{{ Auth::user()->name }}</span>
